...
if ($ADMIN->fulltree) {
    $settings->add(
        new admin_setting_configcheckbox(
            'block_custom_course_menu/enablefavorites',
            get_string('enablefavorites', 'block_custom_course_menu'),
            get_string('configenablefavorites', 'block_custom_course_menu'),
            0
        )
    );
    $settings->add(
        new admin_setting_configcheckbox(
            'block_custom_course_menu/enablelastviewed',
            get_string('enablelastviewed', 'block_custom_course_menu'),
            get_string('configenablelastviewed', 'block_custom_course_menu'),
            0
        )
    );
    $settings->add(
        new admin_setting_configtext(
            'block_custom_course_menu/lastviewedamount',
            get_string('lastviewedamount', 'block_custom_course_menu'),
            get_string('configlastviewedamount', 'block_custom_course_menu'),
            5,
            PARAM_INT
        )
    );
    ...
    $settings->add(
        new admin_setting_configselect(
            'block_custom_course_menu/showsearch',
